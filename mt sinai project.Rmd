...
To account for differences in population density across census tracts, a weighted analysis was conducted by multiplying the proportion of children on public insurance in each tract by its population density. The weighted mean proportion of children on public insurance was then calculated for each racial/ethnic group. This approach helps adjust for the fact that more densely populated areas may have higher numbers of children on public insurance, which could otherwise skew the results.

Results indicate that [insert key findings], with [race/ethnicity group] showing [higher/lower] weighted proportions compared to [other group(s)].
